...
#ifdef USE_FBO
				if ( fboEnabled ) {
					stage->bundle[0].isScreenMap = true;
					shader.hasScreenMap = true;
					tr.needScreenMap = true;
				}
#endif
			} else {
...
=================
*/
static bool CollapseMultitexture( shaderStage_t *st0, shaderStage_t *st1, int num_stages ) {
	int abits, bbits;
	int i;
