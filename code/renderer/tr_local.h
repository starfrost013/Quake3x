...
typedef struct {
	...
	color4ub_t	color2D;
	bool	doneBloom;		// done bloom this frame
...
#ifdef USE_FBO
extern	bool			windowAdjusted;
extern	bool			superSampled;
#endif
...
void	RB_CalcEnvironmentTexCoordsFP( float *dstTexCoords, bool screenMap );
