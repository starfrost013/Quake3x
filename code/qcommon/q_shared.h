...
// print levels from renderer (FIXME: set up for game / gameclient?)
typedef enum {
	PRINT_ALL,
...
// font rendering values used by ui and gameclient
...
#define KEYCATCH_GAMECLIENT      0x0008
...
// so they aren't game/gameclient only definitions
//
...
typedef enum {
	...
	CA_LOADING,			// only during gameclient initialization, never during main loop
